        ...
        <div className="p-3 border border-bg-100 rounded-lg flex items-start">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm mb-4 dark:text-gray-400">
              I grew up in design by doing graphic stuff. Ranging it from logos,
              to whole branding packages to album cover designs. Seeing stuff
              being physical is very satisfying.
            </p>
