    ...
    <div className="h-full dark:bg-blackish">
      ...
      <div className="default-container">
        ...
        <p className="paragraph-1">
          Rapiddo was my first gig. It got me set up in the logistic industry of
          products. As iFood still is, Rapiddo was a company of the Movile
          Group, a huge company that encompasses a bunch of product and services
          in multiple industries. What eventually became the Logistics Tribe at
          iFood was the main Rapiddo team. We got "acquired", more like merged
          by, and then we set out to continue our Rapiddo's efforts beneath
          iFood's umbrella.
          <br />
          <br />
          ...
          money. So as you'd expect, a lot of stuff didn't got out of their MVP.
          ...
          made harder for the ops team communicate the problems they were seeing
          face to face with users.
        </p>
        <H1 content="Have you thought about branding as a product problem?" />
        <p className="paragraph-1">
          Yea... have you? That's what I used to think at Rapiddo. By being a
          ...
          was no branding guidelines whatsoever. And I got out to set up one for
          that. As it was one of my first gigs, I was making simple stuff. But
          looking back, they were fundamental. As I said in the sub-title, I did
          it all there. So, in the early months, I was building a brand
      ...
      <div className="default-container">
        ...
        <p className="paragraph-1">
          ...
          detail about the same issued I faced when in iFood here. But back in
          ...
          to sent some of the ops team around the country to set up a talk, in
          some hotel room, to explain all the bits and pieces of how to be a
          driver in our platform.
          <br />
          <br />
          It used to be a 60+ keynote with bunch of slides showing app screen
          shots and other ones explaining more in depth some of the rules of the
          service. That was tiring and expensive for all of the involved. We had
          to come up with a more scalable way of onboarding and training new
          drivers. We had a constraint of not changing anything in the native
          app. So we really had to be creative. And by that I mean: motion
          graphics. Yes, that's what it was. There I was, 3 months deep into
          After Effects tutorials.
          <br />
          <br />
          We did some really legit startup work there. Very low budget. We got a
          ...
          keynote and talks the team used to give country wide in a set of 7
          ...
          optmizations the team done, we got a pretty stable supply-input
          machine going on.
        </p>
        ...
        <p className="subtitle-text">
          ...
          series of 8. Theres 2 available in my Vimeo account. Take a peek!
        </p>
        <H1 content="Exploring and learning" />
        <p className="paragraph-1">
          By sometime, Rapiddo started to cool things down a bit. That's
          ...
          mean time, we started to dug deep into more problems we had in regards
          to the driver fleet. And these problems really took me off in
          advantage when in iFood, because they were identical. We had so much
          trouble trying to have a stable supply showing to take the orders.
          Because of that, we started to come up with ways to better enhance our
          promotion, the main call-out mechanism, flow in the app. <br />
          <br />
          ...
          be really creative. When you set out for yourself a constraint as hard
          as not much money, you need to think the possibilites with the
          resources at hand. That's when we started to have interesting
