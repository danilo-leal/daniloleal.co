      ...
      <div className="default-container">
        ...
        <div className="py-4 grid gap-8">
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="paragraph-1 mb-4">
                Coop is a streamlined financial organizer for you to follow how
                much you've spent in comparison to what you've expected to
                spend.
              </p>
        ...
        <div className="py-4 grid gap-8">
          <div className="flex items-start">
            ...
            />
            <div>
              <h1 className="mb-2 dark:text-white">Tailwind para Designers</h1>
              <p className="paragraph-1 mb-4">
                A project dedicated to the portuguese speaking design comunnity.
                I'll try to lay down the fundamentals about TailwindCSS in a
                very easy way.
              </p>
              <div className="flex sm:space-x-3 space-y-2 sm:space-y-0 flex-col sm:flex-row">
                <MainLink
