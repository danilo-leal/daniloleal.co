  ...
  return (
    <div className="global-wrapper">
      <NextSeo
        ...
        openGraph={{
          url: "https://daniloleal.co/my-world/album-reviews/sufjan-carrie",
          title: "sufjan stevens: carrie & lowell, a review by danilo leal",
          images: [
            {
      ...
      <div className="default-container">
        ...
        <CaseHeader
          title="Carrie & Lowell"
          summary="By Sufjan Stevens, released in 2015 • Posted at 24/03/2021"
        />
      </div>
      <div className="default-container">
        <Zoom>
        ...
        <p className="paragraph-1">
          I did not know Sufjan before this record. I got to get ahold of some
          of his prior music after listening to this piece and it struck me
          quite a bit how different it sounds. As you get closer to the story
          behind this album, you start to understand more and more where he's
          coming from and things start to settle. A friend with who I used to
        ...
        <p className="paragraph-1">
          ...
          expose details and interviews with the man himself about what's all
          this about for him. I'll try to develop a bit of what this is about to
          me.
          <br />
          <br />
          ...
          won't be here forever. And neither do I. Sometimes our roads will fall
        ...
        <p className="paragraph-1">
          ...
          The core question the article presents is that: if you think of the
        ...
        <p className="paragraph-1">
          I don't know if this is a task that we can conclude with integrity.
          It's hard to really accept someone dying. Even though they might live
          in and through you, I feel like I'd also die a bit. There's some of me
          ...
          that Sufjan naturally goes through this as the record progresses. He
          exposes to us very hard moments where he takes on himself the blame.
          <br />
          ...
          memories come like the clearest movie. It's always possible to act
          differently, to be better. But life is a circumstance. Each moment is
          carried like a result of the previous. It demands hard conscious
        ...
        <p className="paragraph-1">
          ...
          suddenly, I miss everyone. I'm grateful for everyone's lives and I
          want to be better, I want to love them better. The song's melodies and
          overall mood of the album make me feel like I'm at this end of the
          road, on an empty beach. Starring at the horizon, seeing each and
          every people I love. Recollecting our shared moments, our shared love
          and conflict. I feel overwhelmed. A bit shattered into many pieces.
          I'm not certain if it's them or me that is passing away. I guess
          that's accepting their passage and also mine.
        </p>
        <Quote
          quote={[
        ...
        <p className="paragraph-1">
          ...
          around these melodies. Hope you liked it and sorry for the overall
          mess!
        </p>
