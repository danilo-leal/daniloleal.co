...
export default function IconsSocial() {
  return (
    <div className="w-full flex align-middle">
      <a
        href="https://www.linkedin.com/in/danilobleal/"
      ...
      <a
        href="https://twitter.com/danilobleal"
        className="p-3 rounded-full hover:bg-gray-100 dark:hover:bg-black group transition-all">
        <svg
          role="img"
          className="cursor-pointer w-4 h-4 fill-current text-blackish dark:text-white group-hover:text-draplin dark:hover:text-draplin transition-all"
      ...
      <a
        href="https://dribbble.com/danilobleal"
        className="p-3 rounded-full hover:bg-gray-100 dark:hover:bg-black group transition-all">
        <svg
          role="img"
          className="cursor-pointer w-4 h-4 fill-current text-blackish dark:text-white group-hover:text-draplin dark:hover:text-draplin transition-all"
      ...
      <a
        href="https://github.com/danilo-leal"
        className="p-3 rounded-full hover:bg-gray-100 dark:hover:bg-black group transition-all">
        <svg
          role="img"
          className="cursor-pointer w-4 h-4 fill-current text-blackish dark:text-white group-hover:text-draplin dark:hover:text-draplin transition-all"
      ...
      <a
        href="https://medium.com/@daniloleal"
        className="p-3 rounded-full hover:bg-gray-100 dark:hover:bg-black group transition-all">
        <svg
          role="img"
          className="cursor-pointer w-4 h-4 fill-current text-blackish dark:text-white group-hover:text-draplin dark:hover:text-draplin transition-all"
