...
export default function AboutCardInfo() {
  return (
    <div className="bg-gray-50 dark:bg-black rounded-lg p-5 grid sm:grid-cols-3 grid-col-auto gap-4 sm:gap-2">
      ...
      <div>
        <p className="text-gray-400 mb-2 dark:text-gray-600">Find me at:</p>
        <div className="w-full flex align-middle space-x-3">
          ...
          <a href="https://twitter.com/danilobleal">
            <svg
              role="img"
              className="cursor-pointer w-4 h-4 fill-current text-blackish dark:text-white hover:text-draplin dark:hover:text-draplin transition-all"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a href="https://dribbble.com/danilobleal">
            <svg
              role="img"
              className="cursor-pointer w-4 h-4 fill-current text-blackish dark:text-white hover:text-draplin dark:hover:text-draplin transition-all"
              viewBox="0 0 24 24"
          ...
          <a href="https://medium.com/@daniloleal">
            <svg
              role="img"
